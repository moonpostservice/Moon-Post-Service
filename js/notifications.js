...
const MOON_PHASE_SVGS = {
    ...
    'Full Moon': '<svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="fm-mask" fill="white"><path d="M30 0C46.5685 0 60 13.4315 60 30C60 46.5685 46.5685 60 30 60C13.4315 60 0 46.5685 0 30C0 13.4315 13.4315 0 30 0Z"/></mask><path d="M30 0V13C39.3888 13 47 20.6112 47 30H60H73C73 6.25176 53.7482 -13 30 -13V0ZM60 30H47C47 39.3888 39.3888 47 30 47V60V73C53.7482 73 73 53.7482 73 30H60ZM30 60V47C20.6112 47 13 39.3888 13 30H0H-13C-13 53.7482 6.25176 73 30 73V60ZM0 30H13C13 20.6112 20.6112 13 30 13V0V-13C6.25176 -13 -13 6.25176 -13 30H0Z" fill="currentColor" mask="url(#fm-mask)"/></svg>',
    'Waning Gibbous': '<svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 60C13.4315 60 1.17422e-06 46.5685 2.62268e-06 30C4.07115e-06 13.4315 13.4315 -4.07115e-06 30 -2.62268e-06C46.5685 -1.17422e-06 60 13.4315 60 30C60 46.5685 46.5685 60 30 60ZM30.5 48C34.9841 48 38.486 42.5001 39.5 41C40.514 39.5 42.4535 34.9081 42.5 30.5C42.5465 26.0919 41.5005 20.7613 39.75 18.5C37.9995 16.2387 34.7027 13 30.5 13C20.835 13 13 20.835 13 30.5C13 40.165 20.835 48 30.5 48Z" fill="currentColor"/></svg>',
    'Last Quarter': '<svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 60C13.4315 60 1.17422e-06 46.5685 2.62268e-06 30C4.07115e-06 13.4315 13.4315 -4.07115e-06 30 -2.62268e-06C46.5685 -1.17422e-06 60 13.4315 60 30C60 46.5685 46.5685 60 30 60ZM30.5 13C20.835 13 13 20.835 13 30.5C13 40.165 20.835 48 30.5 48L30.5 13Z" fill="currentColor"/></svg>',
    'Waning Crescent': '<svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 0C46.5685 0 60 13.4315 60 30C60 46.5685 46.5685 60 30 60C13.4315 60 0 46.5685 0 30C0 13.4315 13.4315 0 30 0ZM27.2236 14.5469C27.0383 14.2226 26.5808 13.9079 26.1182 14.0244C19.5103 15.7 14.4648 21.4967 14.0557 28.0947L14.0195 28.6592C13.9889 29.1501 14.0008 29.6101 14.0264 30.1035C14.2067 33.5964 15.5945 36.8946 17.9062 39.5137C22.8238 45.0873 31.007 46.5909 37.6826 43.2051C41.9352 41.0485 44.8466 37.2821 46 32.7861V32.3672C45.8683 32.0502 45.6842 31.7767 45.3799 31.6885C45.0232 31.5854 44.6273 31.5944 44.3281 31.833C42.6238 33.1941 40.6379 34.1436 38.4375 34.4805C34.4943 35.0846 30.5203 33.7578 27.8135 30.9834C25.067 28.1679 23.9364 24.2036 24.8008 20.3838C25.1895 18.6624 25.9287 17.0901 27.0742 15.7354C27.376 15.3786 27.4474 14.9384 27.2236 14.5469Z" fill="currentColor"/></svg>'
};
...
async function logOut() {
    closeSettings();
    // Show the landing page immediately — no waiting for network, no reload.
    // Reset all in-memory state so the app is fully torn down.
